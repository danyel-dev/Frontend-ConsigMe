        ...
        <div className={styles.home}>
            ...
            <main className={styles.main}>
                <div className={styles.banner}>
                    ...
                    <img className={styles.bannerImage} src="https://img.freepik.com/vetores-gratis/ilustracao-de-revendedor-de-design-plano_23-2149484586.jpg?w=2000" alt="ilustração de revendedor" />
                </div>
